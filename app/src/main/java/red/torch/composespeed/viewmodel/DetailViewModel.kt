 ...
 */
package red.torch.composespeed.viewmodel
...
import red.torch.composespeed.data.repository.DogDetailInfo
import red.torch.composespeed.data.repository.DogRepository
    ...
    fun fetchDogDetail(dogId: Int) {
        viewModelScope.launch {
            when (val result = dogRepository.getDetail(dogId)) {
                is red.torch.composespeed.data.RepoResult.Success -> {
